...
local function GetDeteMode(PalletNumber, State)
    ...
    if PalletNumber.MultSensorFunction ~= 0 or SimulateMode == 1 then
        ...
        OffSet, VacuumCup = GetBoxProPerty(PalletName, PalletNumber.Pallet, Num)
    end
    ...
    if SimulateMode == 1 then
        ...
        if PalletNumber.Mode == 1 then
            if VacuumCup == 0 then -- 单个箱子
                ...
                local BoxCnt
                if VacuumCup == -1 then
                    BoxCnt = PalletVacuumCupFunc
                else
                    BoxCnt = math.ceil(VacuumCup * 0.5)
                end
    ...
    if VacuumCup == 0 then
        ...
        if VacuumCup == 1 or VacuumCup == 2 then
        ...
        if VacuumCup == 3 or VacuumCup == 4 then
            if (DI(PalletNumber.BoxBeInpPlaceDI1) == State)
        ...
        if VacuumCup == 5 or VacuumCup == 6 or VacuumCup == -1 then
            if (DI(PalletNumber.BoxBeInpPlaceDI1) == State)
                and (DI(PalletNumber.BoxBeInpPlaceDI2) == State)
