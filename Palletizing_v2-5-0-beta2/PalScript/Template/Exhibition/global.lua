...
FirstPallet = 
{
	...
	BoxProperty = 
    {
        ...
        OffsetY = 100,
        OffsetZ = 200,
        VacuumCup = 0,    --吸盘属性，单吸 = 0，双吸 = 1
        VacuumCupRz = 90, --吸盘RZ旋转补偿量(-90/0/90/180)
...
PalletVacuumCupFunc = 1         --多吸盘功能, -1：通讯控制单吸, 1：通用单吸， 2：通用双吸
...
LayerSheetSignal = 22                                            --隔板取放IO信号	
LayerSheetSignalFunction = false                                 --独立隔板IO信号开关，false：关闭，true：打开
FilmDI = 24                                                  --缠膜IO
FilmFlag = true                                              --缠膜标志位
